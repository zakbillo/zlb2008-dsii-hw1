...
```{r}
preds <- predict(enet.fit$finalModel, 
                     newx = model.matrix(sale_price ~ ., housing_test)[,-1], 
...
test_error # Test MSE is 445035300
```
...
The optimal $\lamda = 22.44597$ for $\alpha = 1$ (L1 penalty / Lasso). Let's look at the Test MSE now
...
Lasso with "caret" has a Test MSE of 446,277,782 (which corresponds to an average error of roughly $21,125 per house, the RMSE). 
